...
const Card1 = () => {
  return (
    <div className='bg-white'>
        <h3 className='font-bold text-4xl text-center text-indigo-900'>Our <span className='text-amber-500'>Features</span></h3>
        ...
        <div className='w-[1547px] flex gap-[236px] items-center mt-[140px] mx-auto  '>
                <div>
                    <h4 className='font-semibold text-4xl leading-10 text-start mt-[100px] text-indigo-900 mb-[30px] '><span className='text-amber-500'>Tools</span> For Teachers And Learners</h4>
